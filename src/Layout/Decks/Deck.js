  ...
  if (!deck || !cards) {
    ...
    return (
      <div className="col-9 mx-auto">
        ...
        {/* container holding card deck, w/ name, description, study button, edit button, add cards button, delete button */}
        ...
        {/* container of all cards, including their front, back, edit button, delete button */}
                ...
                <div className="d-flex justify-content-end p-2">
                  ...
                  <button
                    onClick={async () => {
                      if (
                        window.confirm(
                          "Are you sure you want to delete this card? This action is not undo-able."
                        )
                      ) {
